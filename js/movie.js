  ...
  fetch(url, options)
    ...
    .then((json) => {
      ...
      information.innerHTML += `
        <img id='movie-info-img' src='https://media.themoviedb.org/t/p/w220_and_h330_face${
          json.poster_path
        }' alt='${json.original_title}'>
        <div class='img-info'>
            <h1 class='movie-name'>${json.original_title}<span class='year'>(${
        ...
        json.runtime - 60 * Math.floor(json.runtime / 60)
            ...
            <div class='flex paddingLeft info-three'>
                <div class="circular-progress rating">
                    <span class="percentage" style='font-size: 22px;'>${
                      json.vote_count
